...
if st.session_state.analise_feita:
    ...
    try:
        ...
        4. Classifique com base nisso:
           ...
           - ⚠️Parcialemente compatível: ação incompleta, sem evidência ou com risco alto
        ...
        elif "⚠️ Parcialemente" in analise_acao:
            st.session_state.classificacao_final = "⚠️Parcialemente compatível"
        ...
        try:
            ...
            try:
                ...
                if os.path.exists("memoria/historico.csv"):
                    ...
                    candidatos = df[
                        df['num_recisao'].str.contains(pergende, case=False, na=True) |
                        df['recomendacao'].str.contains(pergende, case=False, na=True) |
                        df['gestor'].str.contains(pergende, case=False, na=True)
                    ]
